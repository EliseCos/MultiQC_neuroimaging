...
DATA_MODELS_JSON = {
    "Bundle1": {
        ...
        "md": {
            "regression_reference": {"site": "RefSite", "data_x": [20, 80], "data_y": [0.001, 0.002], "color": [255, 0, 0]},
            "regression_moving": {"site": "MovSite", "data_x": [20, 80], "data_y": [0.002, 0.003], "color": [0, 0, 255]}
        }
    }
}
