...
def test_battacharyya_build_html(reset_multiqc, test_data_dir):
    ...
    assert 'style="max-width:800px; margin: 0 auto; display: block;"' in html_content.content # Default metric should be visible
    assert 'style="max-width:800px; margin: 0 auto; display: none;"' in html_content.content # Other metric should be hidden
